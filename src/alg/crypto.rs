...
mod tests {
    ...
    #[test]
    fn test_k256_sign() {
        let hex = hex::decode("9b228700b59fa9bc2afd675894051d2016083adaca23ae031f848f609ce25d01")
            .unwrap();

        let sk = hex::decode("0bc0bb17546bea74ce589ce21caae32ae3302f1fdda1c370fcb381c8155d536c")
            .unwrap();

        let signature = hex::decode("c160e6652a71dfbe54b11663e6d674551687ce6e26217d6f8fceb08057eeb61f54a7b1f666a9cae8a10a0627b78e05205f6845c9097b5decb14a8f00b3d420bb1b").unwrap();
